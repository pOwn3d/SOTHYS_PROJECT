 ...
 */
final class Version20210504085021 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE customer_incoterm (id INT AUTO_INCREMENT NOT NULL, reference_id INT DEFAULT NULL, society_customer_incoterm_id INT DEFAULT NULL, city VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, INDEX IDX_4C83B597B49182E (society_customer_incoterm_id), INDEX IDX_4C83B5971645DEA9 (reference_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf($this->connection->getDatabasePlatform()->getName() !== 'mysql', 'Migration can only be executed safely on \'mysql\'.');
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, society_id_id INT DEFAULT NULL, id_order INT DEFAULT NULL, id_order_x3 INT DEFAULT NULL, date_order DATETIME NOT NULL, date_delivery DATETIME DEFAULT NULL, id_statut INT NOT NULL, id_down_statut INT DEFAULT NULL, reference VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, date_last_delivery DATETIME DEFAULT NULL, price_order DOUBLE PRECISION DEFAULT NULL, INDEX IDX_F5299398B5E86723 (society_id_id), UNIQUE INDEX UNIQ_F52993987B9266EA (id_order_x3), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf($this->connection->getDatabasePlatform()->getName() !== 'mysql', 'Migration can only be executed safely on \'mysql\'.');
        ...
        $this->addSql('CREATE TABLE order_line (id INT AUTO_INCREMENT NOT NULL, item_id_id INT DEFAULT NULL, id_order INT DEFAULT NULL, id_order_line INT DEFAULT NULL, quantity INT NOT NULL, price VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, price_unit VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, remaining_qty_order INT DEFAULT NULL, id_order_x3 INT DEFAULT NULL, INDEX IDX_9CE58EE155E38587 (item_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf($this->connection->getDatabasePlatform()->getName() !== 'mysql', 'Migration can only be executed safely on \'mysql\'.');
